...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <svg height="80"; width="600" style="position:relative; left: 215px; top: -10px"> 
                <text x="0" y="60" fill="black" font-size="33" font-weight="bold" >Sign in or create an account</text>
            </svg>	         
        </div>
                    ...
                    <form method="POST" action="{{ route('staff.login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" style="font-size:18; font-weight:bold; position:relative; left:160px; top:40px" class="inline-block px-4 py-2 btn-registration">
                                    {{ __('Sign in') }}
                                </button>
                            </div>
                        </div>
        ...
        <div class="row col-6" style="position:relative; top:0px; left:-125px" onclick="ilang()">
