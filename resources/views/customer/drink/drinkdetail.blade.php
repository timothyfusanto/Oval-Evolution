...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color: #EAEFF2; font-family:Roboto; color:black">
        ...
        <?php 
            if($user) {
                $exist = drinkfavourite::where('user_id', $user->id)->where('drink_id', $datashow->id)->first();
            };
        ?>
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                        <div class="row mb-3 mt-5">
                            <div class="col-md-4">
                                <img src="{{ asset('storage/' . $datashow->image) }}" alt="Card image cap" style="width:90%; max-width:400px; max-height:300px; 
                                height:90%; border-radius:20px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">                                
                            </div>
                            
                            <div class="col-md-8">
                                <div class="row mb-4" style="font-size:40px; font-weight:bold; align-items:center">
                                    ...
                                    @if($user)
                                        ...
                                        <div class="col-md-4" style="text-align:right">
                                            <form id="favouriteForm" action="{{ route('drinkfavourite.remove') }}" method="post">
                                                @csrf
                                                {{ method_field('delete') }}
                                                <input type="hidden" value="{{$datashow->id}}" name="drink_id">
                                                <i id="heartIcon" class="fa fa-heart favouriteIcon filledHeart mr-4 mb-4" style="cursor: pointer; font-size:30px;"></i>
                                            </form>
                                        </div>
                                        @else 
                                        <div class="col-md-4" style="text-align:right">
                                            <form id="favouriteForm" action="{{ route('drinkfavourite.add') }}" method="post">
                                                @csrf 
                                                <input type="hidden" value="{{$datashow->id}}" name="drink_id">
                                                <i id="heartIcon" class="fa fa-heart favouriteIcon mr-4 mb-4" style="cursor: pointer; font-size:30px;"></i>
                                            </form>
                                        </div>
                                        @endif
                                    @else
                                        <div class="col-md-4" style="text-align:right">
                                            <a href="/favourites">
                                                <i class="fa fa-heart mr-4 mb-4" style="cursor: pointer; font-size:30px;"></i>
                                            </a>
                                        </div>
                                    @endif
                                ...
                                <div class="row mt-3" style="font-size:20px"> 
                                    <div class="col-md-4">
                                        Price : ${{$datashow->price_in_sgd}}
                                    </div>
                                    <div class="col-md-4">
                                        <div style="font-size:20px; color:black" class="mr-2"> Ratings : 
                                            @if($datashow->reviews->count() !== 0)
                                                @php
                                                    $averageRate = round($datashow->reviews->sum('star_rating') / $datashow->reviews->count(), 1);
                                                @endphp
                                                {{$averageRate}}
                                            @else
                                                -
                                ...
                                <div class="row mt-2 mb-2" style="font-size:14px"> 
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button class="btn btn-roundabit btn-black waves-effect waves-light mt-4" data-toggle="modal" data-target=".bd-example-modal-form" 
                                            style=" width:100%; font-weight:bold">Customize 
                                            <i class="fas fa-pencil-alt ml-1" style="cursor: pointer; font-size:13px; color:white"></i>        
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-4 mb-5" style="font-size:20px">
                            <div class="col">
                                Customization available :
                            </div>
                        </div>

                        @if(!empty($datashow->head1_items))
                        @php
                            $json1 = explode(', ' ,$datashow->head1_items);    
                            $jsonprice1 = explode(', ' ,$datashow->head1_price);    
                        @endphp
                            ...
                            <div class="col-md-9">
                                @foreach($json1 as $p => $json0)
                                    <div style="display: flex; align-items: center;" class="mb-4">
                                        <div class="" style="font-size: 17px; color: black; text-align: left; flex: 1;">{{$json0}}</div>
                                        @if(isset($jsonprice1[$p]) && !empty($jsonprice1[$p]))
                                            <div class="" style="font-size: 17px; color: black; text-align: right; margin-left: 10px;">+ ${{$jsonprice1[$p]}}</div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @if(!empty($datashow->head2_items))
                        @php
                            $json2 = explode(', ' ,$datashow->head2_items);    
                            $jsonprice2 = explode(', ' ,$datashow->head2_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$datashow->cust_head2}} :
                            ...
                            <div class="col-md-9">
                                @foreach($json2 as $p => $json0)
                                    <div style="display: flex; align-items: center;" class="mb-4">
                                        <div class="" style="font-size: 17px; color: black; text-align: left; flex: 1;">{{$json0}}</div>
                                        @if(isset($jsonprice2[$p]) && !empty($jsonprice2[$p]))
                                            <div class="" style="font-size: 17px; color: black; text-align: right; margin-left: 10px;">+ ${{$jsonprice2[$p]}}</div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @if(!empty($datashow->head3_items))
                        @php
                            $json3 = explode(', ' ,$datashow->head3_items);    
                            $jsonprice3 = explode(', ' ,$datashow->head3_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$datashow->cust_head3}} :
                            ...
                            <div class="col-md-9">
                                @foreach($json3 as $p => $json0)
                                    <div style="display: flex; align-items: center;" class="mb-4">
                                        <div class="" style="font-size: 17px; color: black; text-align: left; flex: 1;">{{$json0}}</div>
                                        @if(isset($jsonprice3[$p]) && !empty($jsonprice3[$p]))
                                            <div class="" style="font-size: 17px; color: black; text-align: right; margin-left: 10px;">+ ${{$jsonprice3[$p]}}</div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @if(!empty($datashow->head4_items))
                        @php
                            $json4 = explode(', ' ,$datashow->head4_items);    
                            $jsonprice4 = explode(', ' ,$datashow->head4_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$datashow->cust_head4}} :
                            ...
                            <div class="col-md-9">
                                @foreach($json4 as $p => $json0)
                                    <div style="display: flex; align-items: center;" class="mb-4">
                                        <div class="" style="font-size: 17px; color: black; text-align: left; flex: 1;">{{$json0}}</div>
                                        @if(isset($jsonprice4[$p]) && !empty($jsonprice4[$p]))
                                            <div class="" style="font-size: 17px; color: black; text-align: right; margin-left: 10px;">+ ${{$jsonprice4[$p]}}</div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @if(!empty($datashow->head5_items))
                        @php
                            $json5 = explode(', ' ,$datashow->head5_items);    
                            $jsonprice5 = explode(', ' ,$datashow->head5_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$datashow->cust_head5}} :
                            ...
                            <div class="col-md-9">
                                @foreach($json5 as $p => $json0)
                                    <div style="display: flex; align-items: center;" class="mb-4">
                                        <div class="" style="font-size: 17px; color: black; text-align: left; flex: 1;">{{$json0}}</div>
                                        @if(isset($jsonprice5[$p]) && !empty($jsonprice5[$p]))
                                            <div class="" style="font-size: 17px; color: black; text-align: right; margin-left: 10px;">+ ${{$jsonprice5[$p]}}</div>
                                        @endif
                                    </div>
                                @endforeach
                            </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12" style="text-align: center;">
                                                    ...
                                                    box-sizing:border-box;" src="{{ asset('storage/' . $datashow->image) }}" alt="Card image cap">    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12" style="text-align: center; display:flex">
                                                    <h4 class="card-title mt-4 truncate" style="font-size:28px; color:#2E2E2E; text-align :left; width:380px">{{$datashow->name}}</h4>
                                                    <h4 class="card-title mt-4 mr-3" style="font-size:23px; color:#2E2E2E; text-align :right; flex-grow:1">${{$datashow->price_in_sgd}}</h4>
                                                </div>
                                            </div>
                                            
                                            <form action="{{route('addToCart')}}" method="post">
                                                @csrf
                                                @if(!empty($datashow->cust_head1))
                                                    @if($datashow->requirements1 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head1}}</label>
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head1}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$datashow->requirements1}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value1 = parseInt('{{$datashow->requirements1}}');
                                                ...
                                                @if(!empty($datashow->cust_head2))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($datashow->requirements2 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$datashow->requirements2}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$datashow->head2_items);    
                                                        $jsonprice1 = explode(', ' ,$datashow->head2_price);    
                                                    @endphp
                                                    @if($datashow->requirements2 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value2 = parseInt('{{$datashow->requirements2}}');
                                                ...
                                                @if(!empty($datashow->cust_head3))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($datashow->requirements3 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$datashow->requirements3}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$datashow->head3_items);    
                                                        $jsonprice1 = explode(', ' ,$datashow->head3_price);    
                                                    @endphp
                                                    @if($datashow->requirements3 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value3 = parseInt('{{$datashow->requirements3}}');
                                                ...
                                                @if(!empty($datashow->cust_head4))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($datashow->requirements4 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$datashow->requirements4}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$datashow->head4_items);    
                                                        $jsonprice1 = explode(', ' ,$datashow->head4_price);    
                                                    @endphp
                                                    @if($datashow->requirements4 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value4 = parseInt('{{$datashow->requirements4}}');
                                                ...
                                                @if(!empty($datashow->cust_head5))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($datashow->requirements5 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$datashow->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$datashow->requirements5}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$datashow->head5_items);    
                                                        $jsonprice1 = explode(', ' ,$datashow->head5_price);
                                                    @endphp
                                                    @if($datashow->requirements5 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value5 = parseInt('{{$datashow->requirements5}}');
                                            ...
                                            <div class="modal-footer mt-4">
                                                <input name="drink_id" value="{{$datashow->id}}" class="hidden">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <a href="{{route('drinkreview.show', [$datashow->id])}}">
                                    <button class="btn btn-black" style="font-size:15px">See all reviews <i class="fas fa-star"></i></button>
                                </a>
                            </div>
                        </div>
                </div>
