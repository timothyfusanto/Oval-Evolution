    ...
    <body style="background-color:#EAEFF2; font-family:Roboto; color:black">
        ...
        <div class="row mt-5">
            <div class="col-md-12" style="text-align: center; color:black">
                <h2>No drink added to favourite.</h2>
            </div>
        </div>
        ...
        @else
            <div class="row ml-5 mr-5">
                @foreach($favourite as $key => $dataindex0)
                    @if($dataindex0->drink->del_stat != 0)
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <a href="{{route('drink.show' , [$dataindex0->drink->id])}}">
                        <img class="card-img-top img-fluid zoom" style="width: 320px; height:200px; border-radius: 30px; padding:13px;
                        box-sizing:border-box;" src="{{ asset('storage/' . $dataindex0->drink->image) }}" alt="Card image cap">
                    </a>
                        <div class="card-body" style="background-color: white;">
                            <div style="display: flex;">
                                <h4 class="card-title truncate" style="font-size:18px; color:black; width:78%" onclick="readMore(this)">{{$dataindex0->drink->name}}</h4>
                                <h4 class="card-title truncate" style="text-align: right; font-size:18px; color:black">$ {{$dataindex0->drink->price_in_sgd}}</h4> 
                            </div>                       
                            ...
                            @if($user)
                                ...
                                <form id="favouriteForm{{ $key }}" action="{{ route('drinkfavourite.remove') }}" method="post">
                                    ...
                                    <input type="hidden" value="{{$dataindex0->drink->id}}" name="drink_id">
                            ...
                            @endif
                                ...
                                <a href="{{route('drinkreview.show', [$dataindex0->drink->id])}}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12" style="text-align: center; display:flex">
                                                    <h4 class="card-title mt-4 truncate" style="font-size:28px; color:#2E2E2E; text-align :left; width:380px">{{$dataindex0->drink->name}}</h4>
                                                    <h4 class="card-title mt-4 mr-3" style="font-size:23px; color:#2E2E2E; text-align :right; flex-grow:1">${{$dataindex0->drink->price_in_sgd}}</h4>
                                                </div>
                                            </div>
                                            
                                            <form action="{{route('addToCart')}}" method="post">
                                                @csrf
                                                @if(!empty($dataindex0->drink->cust_head1))
                                                    @if($dataindex0->drink->requirements1 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head1}}</label>
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head1}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->drink->requirements1}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->drink->head1_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->drink->head1_price);    
                                                    @endphp
                                                    @if($dataindex0->drink->requirements1 == 'yes')
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value1 = parseInt('{{$dataindex0->drink->requirements1}}');
                                                ...
                                                @if(!empty($dataindex0->drink->cust_head2))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->drink->requirements2 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->drink->requirements2}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->drink->head2_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->drink->head2_price);    
                                                    @endphp
                                                    @if($dataindex0->drink->requirements2 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value2 = parseInt('{{$dataindex0->drink->requirements2}}');
                                                ...
                                                @if(!empty($dataindex0->drink->cust_head3))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->drink->requirements3 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->drink->requirements3}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->drink->head3_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->drink->head3_price);    
                                                    @endphp
                                                    @if($dataindex0->drink->requirements3 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value3 = parseInt('{{$dataindex0->drink->requirements3}}');
                                                ...
                                                @if(!empty($dataindex0->drink->cust_head4))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->drink->requirements4 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->drink->requirements4}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->drink->head4_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->drink->head4_price);    
                                                    @endphp
                                                    @if($dataindex0->drink->requirements4 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value4 = parseInt('{{$dataindex0->drink->requirements4}}');
                                                ...
                                                @if(!empty($dataindex0->drink->cust_head5))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->drink->requirements5 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->drink->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->drink->requirements5}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->drink->head5_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->drink->head5_price);    
                                                    @endphp
                                                    @if($dataindex0->drink->requirements5 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value5 = parseInt('{{$dataindex0->drink->requirements5}}');
                                            ...
                                            <div class="modal-footer mt-4">
                                                <input name="drink_id" value="{{$dataindex0->drink->id}}" class="hidden">
