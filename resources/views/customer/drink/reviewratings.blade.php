...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color: #EAEFF2; font-family:Roboto; color:black">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-md-4" style="border-right: 1px solid #696969">
                ...
                <div class="col-md-4" style="justify-content:center; text-align:center; border-right:1px solid #696969">
                    <div style="font-size:23px;">
                        Average Rating
                    </div>
            ...
            <div style="border-top:1px solid #696969;" class="mt-5 mb-4"></div>
            <?php
                if($user) {
