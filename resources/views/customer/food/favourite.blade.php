...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color:#EAEFF2; font-family:Roboto; color:black">
                ...
                <div class="search-bar ml-5">
                    <form action="{{route('searched.index')}}" method="get">
                        ...
                        <div class="input-group">
                            <input required name="product_name" type="search" class="form-control" id="search_product" placeholder="Search food..." aria-label="Username" aria-describedby="basic-addon1">
        ...
        <div class="row ml-5 mt-4">
            <div class="col-md-12">
                <div style="font-size:40px; font-weight:bold; margin-left:15px;">
        ...
        <div class="row mt-5">
            <div class="col-md-12" style="text-align: center;">
                <img src="{{ url('/template/assets/images/man-removebg-preview.png') }}" style="width:250px; height:250px;">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-12" style="text-align: center; color:black">
                <h2>No food added to favourite.</h2>
            </div>
        </div>
    
        @else
            <div class="row ml-5 mr-5">
                @foreach($favourite as $key => $dataindex0)
                @if($dataindex0->food->del_stat != 0)
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <a href="{{route('food.show' , [$dataindex0->food->id])}}">
                        <img class="card-img-top img-fluid zoom" style="width: 320px; height:200px; border-radius: 30px; padding:13px;
                        box-sizing:border-box;" src="{{ asset('storage/' . $dataindex0->food->image) }}" alt="Card image cap">
                    </a>
                        <div class="card-body" style="background-color: white;">
                            <div style="display: flex;">
                                <h4 class="card-title truncate" style="font-size:18px; color:black; width:78%" onclick="readMore(this)">{{$dataindex0->food->name}}</h4>
                                <h4 class="card-title truncate" style="text-align: right; font-size:18px; color:black">$ {{$dataindex0->food->price_in_sgd}}</h4> 
                            </div>                       
                            <p class="card-text truncate-desc" style="width:100%; height:65px;">{{$dataindex0->food->description}}</p>
                            <div style="display: flex; justify-content: space-between;">
                                <form id="favouriteForm{{ $key }}" action="{{ route('favourite.remove') }}" method="post">
                                    @csrf {{method_field('delete')}}
                                    <input type="hidden" value="{{$dataindex0->food->id}}" name="food_id">
                                ...
                                <a href="{{route('review.show', [$dataindex0->food->id])}}">
                                    ...
                                    <div class="modal-content" style="border-radius:20px;">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('addToCart')}}" method="post">
                                                @csrf
                                                @if(!empty($dataindex0->food->cust_head1))
                                                    @if($dataindex0->food->requirements1 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head1}}</label>
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head1}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->food->requirements1}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->food->head1_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->food->head1_price);    
                                                    @endphp
                                                    @if($dataindex0->food->requirements1 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                            <label class="btn btn-round btn-outline-black mb-3" style="max-width:150px; height:36px">
                                                                <input type="radio" name="options1" value="{{$json0}}" @if ($loop->first) checked @endif>{{$json0}}
                                                                @if(isset($jsonprice1[$p]) && !empty($jsonprice1[$p]))
                                                                <label class="" style="font-size: 14px;text-align: right; width: 50px; margin-left: 10px;">+ ${{$jsonprice1[$p]}}</label>
                                                                @endif
                                                            </label>
                                                        @endforeach
                                                        </div>
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value1 = parseInt('{{$dataindex0->food->requirements1}}');
                                                ...
                                                @if(!empty($dataindex0->food->cust_head2))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->food->requirements2 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->food->requirements2}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->food->head2_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->food->head2_price);    
                                                    @endphp
                                                    @if($dataindex0->food->requirements2 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                            <label class="btn btn-round btn-outline-black">
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value2 = parseInt('{{$dataindex0->food->requirements2}}');
                                                ...
                                                @if(!empty($dataindex0->food->cust_head3))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->food->requirements3 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->food->requirements3}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->food->head3_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->food->head3_price);    
                                                    @endphp
                                                    @if($dataindex0->food->requirements3 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value3 = parseInt('{{$dataindex0->food->requirements3}}');
                                                ...
                                                @if(!empty($dataindex0->food->cust_head4))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->food->requirements4 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->food->requirements4}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->food->head4_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->food->head4_price);    
                                                    @endphp
                                                    @if($dataindex0->food->requirements4 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                            <label class="btn btn-round btn-outline-black" style="max-width:150px; height:36px">
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value4 = parseInt('{{$dataindex0->food->requirements4}}');
                                                ...
                                                @if(!empty($dataindex0->food->cust_head5))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($dataindex0->food->requirements5 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$dataindex0->food->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$dataindex0->food->requirements5}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$dataindex0->food->head5_items);    
                                                        $jsonprice1 = explode(', ' ,$dataindex0->food->head5_price);    
                                                    @endphp
                                                    @if($dataindex0->food->requirements5 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value5 = parseInt('{{$dataindex0->food->requirements5}}');
                                            ...
                                            <div class="modal-footer mt-4">
                                                <input name="food_id" value="{{$dataindex0->food->id}}" class="hidden">
