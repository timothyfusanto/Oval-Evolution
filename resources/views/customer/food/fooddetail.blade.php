    ...
    <body style="background-color: #EAEFF2; font-family:Roboto; color:black">
        ...
        <header class="header-block">
            <div class="flex items-center">
                ...
                <div class="btn-group">
                    <div type="button" style="position:relative; left: -110px; top: 0px; margin-right: 10px; color:black; font-size:16px; 
                ...
                <div class="search-bar ml-5">
                    <form action="{{route('searched.index')}}" method="get">
                        @csrf
                        <div class="input-group">
                            <input required name="product_name" type="search" class="form-control" id="search_product" placeholder="Search..." aria-label="Username" aria-describedby="basic-addon1">
        ...
        <?php 
            if($user) {
                $exist = favourite::where('user_id', $user->id)->where('food_id', $food->id)->first();
            };
        ?>
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                        <div class="row mb-3 mt-5">
                            <div class="col-md-4">
                                <img src="{{ asset('storage/' . $food->image) }}" alt="Card image cap" style="width:90%; max-width:400px; max-height:300px; 
                            ...
                            <div class="col-md-8">
                                <div class="row mb-4" style="font-size:40px; font-weight:bold; align-items:center">
                                    ...
                                    @if($user)
                                        ...
                                        <div class="col-md-4" style="text-align:right">
                                            <form id="favouriteForm" action="{{ route('favourite.welcomeRemove') }}" method="post">
                                                @csrf
                                                {{ method_field('delete') }}
                                        ...
                                        @else 
                                        <div class="col-md-4" style="text-align:right">
                                            <form id="favouriteForm" action="{{ route('favourite.welcomeAdd') }}" method="post">
                                                @csrf 
                                                <input type="hidden" value="{{$food->id}}" name="food_id">
                                ...
                                <div class="row mt-3" style="font-size:20px"> 
                                    <div class="col-md-4">
                                        Price : ${{$food->price_in_sgd}}
                                    </div>
                                    <div class="col-md-4">
                                        <div style="font-size:20px; color:black" class="mr-2"> Ratings : 
                                            @if($food->reviews->count() !== 0)
                                                @php
                                                    $averageRate = round($food->reviews->sum('star_rating') / $food->reviews->count(), 1);
                                                @endphp
                                                {{$averageRate}}
                                            @else
                                                -
                        ...
                        @if(!empty($food->head1_items))
                        @php
                            $json1 = explode(', ' ,$food->head1_items);    
                            $jsonprice1 = explode(', ' ,$food->head1_price);    
                        @endphp
                        ...
                        @if(!empty($food->head2_items))
                        @php
                            $json2 = explode(', ' ,$food->head2_items);    
                            $jsonprice2 = explode(', ' ,$food->head2_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$food->cust_head2}} :
                        ...
                        @if(!empty($food->head3_items))
                        @php
                            $json3 = explode(', ' ,$food->head3_items);    
                            $jsonprice3 = explode(', ' ,$food->head3_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$food->cust_head3}} :
                        ...
                        @if(!empty($food->head4_items))
                        @php
                            $json4 = explode(', ' ,$food->head4_items);    
                            $jsonprice4 = explode(', ' ,$food->head4_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$food->cust_head4}} :
                        ...
                        @if(!empty($food->head5_items))
                        @php
                            $json5 = explode(', ' ,$food->head5_items);    
                            $jsonprice5 = explode(', ' ,$food->head5_price);    
                        @endphp
                        <div class="row mt-4" style="font-size:17px">
                            <div class="col-md-3">
                                {{$food->cust_head5}} :
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12" style="text-align: center;">
                                                    ...
                                                    box-sizing:border-box;" src="{{ asset('storage/' . $food->image) }}" alt="Card image cap">    
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12" style="text-align: center; display:flex">
                                                    <h4 class="card-title mt-4 truncate" style="font-size:28px; color:#2E2E2E; text-align :left; width:380px">{{$food->name}}</h4>
                                                    <h4 class="card-title mt-4 mr-3" style="font-size:23px; color:#2E2E2E; text-align :right; flex-grow:1">${{$food->price_in_sgd}}</h4>
                                                </div>
                                            </div>
                                            
                                            <form action="{{route('addToCart')}}" method="post">
                                                @csrf
                                                @if(!empty($food->cust_head1))
                                                    @if($food->requirements1 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head1}}</label>
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head1}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$food->requirements1}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value1 = parseInt('{{$food->requirements1}}');
                                                ...
                                                @if(!empty($food->cust_head2))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($food->requirements2 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head2}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$food->requirements2}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$food->head2_items);    
                                                        $jsonprice1 = explode(', ' ,$food->head2_price);    
                                                    @endphp
                                                    @if($food->requirements2 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value2 = parseInt('{{$food->requirements2}}');
                                                ...
                                                @if(!empty($food->cust_head3))
                                                    <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($food->requirements3 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head3}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$food->requirements3}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$food->head3_items);    
                                                        $jsonprice1 = explode(', ' ,$food->head3_price);    
                                                    @endphp
                                                    @if($food->requirements3 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @endforeach
                                                        <script>
                                                            ...
                                                            var json0Value3 = parseInt('{{$food->requirements3}}');
                                                ...
                                                @if(!empty($food->cust_head4))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($food->requirements4 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head4}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$food->requirements4}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$food->head4_items);    
                                                        $jsonprice1 = explode(', ' ,$food->head4_price);    
                                                    @endphp
                                                    @if($food->requirements4 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value4 = parseInt('{{$food->requirements4}}');
                                                ...
                                                @if(!empty($food->cust_head5))
                                                <div style="border-top: 1px solid #ccc; margin: 10px 0;"></div>
                                                    @if($food->requirements5 == 'yes')
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(choose 1)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="row">
                                                            <div class="col-md-12">                
                                                                <div class="form-group">                                             
                                                                    <label class="control-label mt-4" style="font-size:18px">{{$food->cust_head5}}</label>
                                                                    <label class="control-label mt-4" style="font-size:14px">(up to {{$food->requirements5}} choices)</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    @php
                                                        $json1 = explode(', ' ,$food->head5_items);    
                                                        $jsonprice1 = explode(', ' ,$food->head5_price);
                                                    @endphp
                                                    @if($food->requirements5 == 'yes')
                                                        <div class="btn-group-toggle" data-toggle="buttons">
                                                        @foreach($json1 as $p=>$json0)
                                                    ...
                                                    @else
                                                        ...
                                                        <script>
                                                            ...
                                                            var json0Value5 = parseInt('{{$food->requirements5}}');
                                            ...
                                            <div class="modal-footer mt-4">
                                                <input name="food_id" value="{{$food->id}}" class="hidden">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <a href="{{route('review.show', [$food->id])}}">
