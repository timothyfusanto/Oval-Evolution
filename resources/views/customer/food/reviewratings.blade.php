...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color: #EAEFF2; font-family:Roboto; color:black">
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <img src="{{ asset('storage/' . $food->image) }}" style="width:80%; max-width:fit-content; border-radius:10px; box-shadow: 0 4px 10px 0 black">
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4" style="justify-content:center; text-align:center; border-right:1px solid #808080">
                    <div style="font-size:23px;">
                        Average Rating
                    </div>
            ...
            <div style="border-top:1px solid #808080;" class="mt-5 mb-4"></div>
            <?php
                if($user) {
                    $oneReview = reviewrating::where('user_id', $user->id)->where('food_id',$food->id)->first();
                };
            ?>
            <div class="row mt-5">
                <div class="col">
            ...
            @if($user)
                ...
                <div class="row mb-5">
                    <div class="col mt-4">
                        <form class="py-2 px-4" action="{{route('review.store')}}" style="box-shadow: 0 0 10px 0 #ddd; border-radius:10px;background-color:white" method="POST" autocomplete="off">
                        @csrf
                    ...
                    <div class="col mt-4">   
                        <div class="card" style="box-shadow: 0 0 10px 0 #ddd; border-radius:10px;background-color:white">
                                ...
                                <div class="col-md-4" style="font-size: 20px; text-align:right">
                                    <div class="mr-4">
                                        ...
                                        <div class="dropdown-menu">
                                            <form id="deleteReviewForm" action="{{ route('review.delete', ['id' => $food->id, 'user_id' => $oneReview->user_id]) }}" method="post"> @csrf {{method_field('delete')}}
                            ...
                            <div class="row ml-2 mb-4 mt-3">
                                <div class="col-md-2">
                                    <a href="{{ route('review.edit', ['id' => $food->id, 'user_id' => $oneReview->user_id]) }}">
            ...
            <div class="row mb-4">
                <div class="col">
                    <div style="font-size:23px">Customer Reviews</div>
                </div>
            </div>
            ...
            @if($datashow0->comments !== null)
                ...
                <div class="review-card mr-5 ml-5 mb-5 mt-5">
                    <div class="row" style="align-items: center;">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <input type="hidden" name="food_id" value="{{ $datashow0->id }}">
                                <div class="col" style="display: flex;">
