    ...
    <body style="background-color:#EAEFF2; font-family:Roboto;">
        ...
        @else
            <div class="row ml-5 mr-5">
                ...
                <?php 
                    if($user) {
                        $exist = favourite::where('user_id', $user->id)->where('food_id', $dataindex0->id)->first();
                    };
                ?>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <a href="{{route('food.show' , [$dataindex0->id])}}">
                        ...
                        <div class="card-body" style="background-color: white;">
                            ...
                            @if($user)
                                @if($exist)
                                <form id="favouriteForm{{ $key }}" action="{{ route('favourite.welcomeRemove') }}" method="post">
                                    @csrf {{method_field('delete')}}
                                    <input type="hidden" value="{{$dataindex0->id}}" name="food_id">
                                    <i class="fa fa-heart favouriteIcon filledHeart" data-form-id="{{ $key }}" style="position:relative; cursor: pointer; font-size:25px;"></i>
                                </form>
                                @else 
                                <form id="favouriteForm{{ $key }}" action="{{ route('favourite.welcomeAdd') }}" method="post">
                                    @csrf 
                                    <input type="hidden" value="{{$dataindex0->id}}" name="food_id">
                            ...
                            @endif
                                ...
                                <a href="{{route('review.show', [$dataindex0->id])}}">
                                    ...
                                    <div class="modal-content" style="border-radius:20px;">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-footer mt-4">
                                                <input name="food_id" value="{{$dataindex0->id}}" class="hidden">
