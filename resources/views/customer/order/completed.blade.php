    ...
    <body style="background-color: #EAEFF2; font-family:Roboto;">
        ...
        @endif
            ...
            <div class="row mb-4 mt-4">
                <div class="col-md-1">		
                    <a href="/myorders/all-order" style="color:#BABABA; font-size:16px">
                        All Order
                    </a>
                </div>
                <div class="col-md-1" >
                ...
                <div class="col-md-1">
                    <a href="/myorders/completed" style="color:#59ceb5; border-bottom:1px solid #59ceb5; font-size:16px">
                        Completed
                    </a>
                </div>		
            </div>
            ...
            <div class="row mt-5">
                ...
                <table id="datatable2" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; 
                        ...
                        <tbody style="font-size:18px">
                            ...
                            <tr>
                                <td>{{$item->created_at->setTimezone('Asia/Singapore')->format('d/m/Y')}}</td>
                                <td>{{$item->created_at->setTimezone('Asia/Singapore')->format('H:i')}}</td>
                                <td>{{$item->queue}}</td>
    ...
    $('#clearHistoryButton').click(function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "/myorders/completed";
            }
        });
    });
</script>
