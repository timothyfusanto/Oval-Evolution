...
{{-- for content after card --}}
	...
	<div class="row">
			<div class="col-12">
				<form action="{{route('drink.update',[$dataedit->id])}}" onsubmit="return submit_button()" enctype="multipart/form-data" method="post">@csrf {{method_field('patch')}}
					<div class="card">
...
{{-- for javascript --}}
    ...
    <script type="text/javascript">
		...
		function desc_limit() {
			var desc = $('#desc').val();
			if (desc.length > 100) {
				$('#alert-desc').html('Description is more than 100 characters').attr('error', '1');
