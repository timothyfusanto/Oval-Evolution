...
Route::get('favourite-list', [CustomerController::class, 'favouriteAjax']);
Route::get('drink-list', [CustomerController::class, 'drinkListAjax']);
Route::get('drinkfavourite-list', [CustomerController::class, 'drinkFavouriteAjax']);
...
Route::get('searched-favouritefood', [CustomerController::class, 'searchFavourite'])->name('favouritesearched.index');
Route::get('searched-favouritedrink', [CustomerController::class, 'searchFavouriteDrink'])->name('drinkfavouritesearched.index');
